...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<a class="navbar-brand"  target="_blank"><b>CAR SERVO</b></a>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
		...
		<button onclick="window.location.href = 'car signup.html';" type="button" class="btn btn-outline-secondary" target="_blank">Sign Up</button>
    </div>	
  </div>
</nav>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="#">Trustmarked used cars</a></td>
        <td><a href="#">Dealer solution</a></td>
        
      </tr>
	   <tr>
        <td><a href="#">FAQs </a></td>
        <td><a href="#">Advertise with Us</a></td>
	  ...
	  <td><a href="#">support@servo.com</a></td>
	  </tr>
    </tbody>
  </table>
</div>
