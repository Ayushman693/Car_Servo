...
mysqli_select_db($conn,"car_servo");
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          <tr> 
                               ...
                               <th width="10%">Wash Type</th>  
                               <th width="5%">Date</th>  
							    <th width="5%">Garrage</th> 
                          </tr> 
						  <tr>
<?php				

$sql=mysqli_query($conn,"SELECT * from wash_details");
...
echo '<td>'.$row["gd"]. ' service station'.'</td>';?>
</tr>
<?php
}
?>
