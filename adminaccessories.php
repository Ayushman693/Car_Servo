...
mysqli_select_db($connect,"car_servo");
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
		...
		<div class="dropdown">
<button onclick="myFunction()" class="dropbtn" >Manage Page</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="adminaddpage.php">Add an item</a>
    <a href="admindelpage.php">Delete an item</a>
  </div>
</div>
