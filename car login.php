...
<div id="myCarousel" class="carousel slide" data-ride="carousel"data-interval="3000">
    ...
    <div class="carousel-inner">
	 <div class="item active">
        <img src="pics\1.jpg" alt="Image" class="img-responsive" style="height:400px">      
      </div>
      <div class="item">
...
<div class="jumbotron">
  <div class="container text-center">
    <h2>Log In Now</h2>      
    <p>Thanks for using our services. Get cashback on services which costs more than RS 100</p>
  </div>
</div>
  <div class="login-form">
    ...
    <form action="car signup.html" method="POST">
